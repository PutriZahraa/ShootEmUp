...
//		->SetText("Zombie Survival")->SetPosition(game->GetSettings()->screenWidth * 0.5f - 295, game->GetSettings()->screenHeight - 100.0f)->SetColor(235, 229, 52);
//
//	// Add input mappings
...
//
//			static_cast<GAI02*>(game)->StartGame();
//
